...
The dataframes `rn_info` includes the list of ALRN bodyids (excludes any outliers or ALRNs pending fixes) while `hemibrain_glomeruli_summary` includes info on the types and status of the glomeruli in the dataset.
